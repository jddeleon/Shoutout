      ...
      //------------------------------------------------------------------------
            ...
            class CreateNewUser extends AsyncTask<String, String, String> {
                    ...
                    protected String doInBackground(String... args) {
                            ...
                            JSONObject json = userFunction.registerUser(str_regFirst, str_regLast, str_regUsername, 
                            											str_regEmail, str_regPassword, str_regConfirmPass, 
                            											str_regMajor, str_regAge, str_regGender);
