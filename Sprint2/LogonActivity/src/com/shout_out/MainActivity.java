...
public class MainActivity extends FragmentActivity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if(status!=ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            final String TAG_NUMLOBBIES = "numLobbies";
...
/*                @Override
              ...
              /*  protected String doInBackground(String... args) {
                        ...
                        try {
                                ...
                                int numLobbies = json.getInt(TAG_NUMLOBBIES);
                                
                                for (int i = 1; i <= numLobbies; i++){
                                    double lat = lobbyList.getDouble("lat");
                                    double lng = lobbyList.getDouble("lng");
                                    int lobby_id = lobbyList.getInt("lobby_id");
                                    String lobby_name = lobbyList.getString("lobby_name");
                                    double rad = lobbyList.getDouble("rad");
                                    String thumb_url = lobbyList.getString("thumb_url");
                                }
